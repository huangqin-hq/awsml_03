...
def net():
    '''
    Initializes the model using a pretrained model
    '''
...
def main(args):
    ...
    '''
    model = train(model, loaders['train'], loss_criterion, optimizer, args.epochs, device)
    
    '''
    Test the model to see its accuracy
    '''
    test(model, loaders['test'], loss_criterion, device)
